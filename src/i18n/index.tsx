...
const translations: Record<AppLanguage, Record<string, string>> = {
  pt: {
    ...
    'welcome.feat2Title': '100% Offline & Sincronização',
    'welcome.feat2Desc': 'Estude mesmo sem internet; os dados são sincronizados automaticamente ao reconectar.',
    ...
    'welcome.statsOffline': '100% Offline Ready',
  ...
  en: {
    ...
    'welcome.feat2Title': '100% Offline & Cloud Sync',
    'welcome.feat2Desc': 'Keep learning anywhere without internet; data syncs seamlessly when back online.',
