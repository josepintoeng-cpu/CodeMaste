    ...
    <div className="pb-28 pt-4 px-4 max-w-md md:max-w-2xl mx-auto space-y-5">
      ...
      {!showResult ? (
        <div className="space-y-4">
          ...
          {/* Question Card */}
          <div className="p-5 rounded-2xl bg-[#1A1A1C] border border-white/10 space-y-4 shadow-md">
              ...
              {question.options.map((opt, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-3.5 rounded-xl border text-left text-xs font-medium transition-all min-h-[48px] flex items-center justify-between ${btnStyle}`}
                  >
                    <span>{opt}</span>
            ...
            {isSubmitted && (
              <div className="p-3 bg-black/50 rounded-xl border border-white/10 text-xs text-white/80 space-y-1">
          ...
          {!isSubmitted ? (
            <button
              ...
              className="w-full py-3.5 bg-orange-500 hover:bg-orange-400 active:bg-orange-600 disabled:opacity-50 text-black font-extrabold text-xs uppercase tracking-wider rounded-xl transition-all shadow-md min-h-[48px]"
            >
              Confirmar Resposta
            </button>
          ) : (
            <button
              ...
              className="w-full py-3.5 bg-white hover:bg-white/90 text-black font-extrabold text-xs uppercase tracking-wider rounded-xl transition-all shadow-md min-h-[48px]"
            >
        ...
        /* Result Summary Card */
        <div className="p-6 rounded-3xl bg-[#1A1A1C] border border-white/10 text-center space-y-4 shadow-xl">
          <div
          ...
          <div className="pt-2">
            <button
              onClick={onBack}
              className="w-full py-3.5 bg-orange-500 hover:bg-orange-400 text-black font-extrabold text-xs uppercase tracking-wider rounded-xl transition-all shadow-md min-h-[44px]"
            >
              Voltar às Aulas
            </button>
          </div>
